...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [11576171.430287, -439064.161320, 11617328.096908, -415653.298312], maxZoom: 28, minZoom: 1
    })
});


    var searchLayer = new ol.SearchLayer({
      layer: lyr_smr_all_2015_maret11,
      colName: 'Well_Name',
      zoom: 10,
      collapsed: true,
      map: map
...
map.getView().fit([11576171.430287, -439064.161320, 11617328.096908, -415653.298312], map.getSize());
